...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        # Fith convolutional layer with 256 x 3 x 3 filter kernel (sees 256 x 14 x 14 tensor)
        ...
        # 2nd fully-connected linear layer 2 with 1024 nodes (sees a 1 x 1024 tensor)
    ...
    def forward(self, x):
        ...
        # Convolutional layer 1 with batch normalization, relu activation function and max pooling
        x = self.pool(F.relu(self.conv1(x)))
        
        # Dropout layer 1
        x = self.drop1(x)
        
        # Convolutional layer 2 with batch normalization, relu activation function and max pooling
        x = self.pool(F.relu(self.conv2(x)))
        
        # Dropout layer 2
        x = self.drop2(x)
        
        # Convolutional layer 3 with batch normalization, relu activation function and max pooling
        x = self.pool(F.relu(self.conv3(x)))
        
        # Dropout layer 3
        x = self.drop3(x)
        
        # Convolutional layer 4 with batch normalization, relu activation function and max pooling
        x = self.pool(F.relu(self.conv4(x)))
        
        # Dropout layer 4
        x = self.drop4(x)
        
        # Convolutional layer 5 with batch normalization, relu activation function and max pooling
        ...
        # Fully connected layer 1 with batch normalization and relu activation function
        x = F.relu(self.fc1(x))
        
        # Dropout layer 6
        x = self.drop6(x)
        
        # Fully connected layer 2 with batch normalization and relu activation function
        x = F.relu(self.fc2(x))
    ...
    def predict(self, x):
        ...
        # Feature map after applying relu activation function on activations of convolutional layer conv4
        h = F.relu(a)
        ...
        # Feature map after applying relu activation function on activations of convolutional layer conv5
        h = F.relu(a)
        ...
        # Layer output after applying relu activation function on activations of fully connected layer fc2
        out = F.relu(a)
